...
\subsection{***}
%Suppose f (λx loves(Mary, x)) = (λx Obviously(loves(M ary, x))). What is f and how would you use it in constructing the semantics of “Sue obviously loves Mary?” Hint: Review the pop/push slide near the end of the semantics lecture.
